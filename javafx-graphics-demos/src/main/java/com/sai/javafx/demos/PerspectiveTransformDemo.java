...
public class PerspectiveTransformDemo extends ExtendedApplicationX{
	...
	protected void setup() {
		...
		Group g1 = getNode();
		g1.setEffect(PerspectiveTransformBuilder.create()
							.ulx(10.0)
							.uly(10.0)
							.urx(310.0)
							.ury(40.0)
							...
							.lry(60.0)
							.llx(10.0)
							.lly(90.0).build()	);// Left to right

		Group g2 = getNode();
		g2.setEffect(PerspectiveTransformBuilder.create()
							.ulx(30.0)
							.uly(60.0)
							.urx(290.0)
							.ury(60.0)
							...
							.lry(90.0)
							.llx(10.0)
							.lly(90.0).build()	);// Front to Back

		Group g3 = getNode();
		g3.setEffect(PerspectiveTransformBuilder.create()
							.ulx(310.0)
							.uly(40.0)
							.urx(10.0)
							.ury(10.0)
							...
							.lry(90.0)
							.llx(310.0)
							.lly(60.0).build()	);// Reverse Right to Left

		Group g4 = getNode();
		g4.setEffect(PerspectiveTransformBuilder.create()
							.ulx(10.0)
							.uly(40.0)
							.urx(310.0)
							.ury(10.0)
